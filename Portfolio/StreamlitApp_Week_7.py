...
# CHANGE 1: Updated tickers to match HW4 trained pair (GOOGL target, GOOG partner)
MODEL_INFO = {
...
def display_explanation(input_df, session, aws_bucket):
    ...
    # CHANGE 2: Class index 2 = BUY signal (0=SELL, 1=HOLD, 2=BUY)
    # Both the waterfall plot and the top_feature extraction MUST use the same index
...
if submitted:
    ...
    if status == 200:
        # CHANGE 3: Corrected caption — this is a classifier, not a return prediction
