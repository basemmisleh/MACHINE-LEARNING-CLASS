...
def display_explanation(input_df, session, aws_bucket):
    ...
    #For HW4, on top_feature line "shap_values[0,:,0]", we want to decide to change the second 0 digit into 0, 1, or 2,
    # which means SELL, HOLD, and BUY respectively. The Waterfall line must be consistent as well with our decision.
